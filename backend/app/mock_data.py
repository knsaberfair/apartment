...
PROPERTIES = [
    ...
    {"id": "P-1109", "building": "B 栋", "room": "1109", "layout": "两室一厅", "area": 70.0, "rent": 6100, "status": "occupied", "tenant": "王知夏", "lease_end": "2026-06-12", "tags": ["历史合同"]},
    {"id": "P-1402", "building": "B 栋", "room": "1402", "layout": "两室一厅", "area": 76.0, "rent": 6200, "status": "occupied", "tenant": "沈嘉禾", "lease_end": "2026-12-16", "tags": ["在租"]},
...
MAINTENANCE_ORDERS = [
    {"id": "M-240714-01", "title": "空调制冷异常", "room": "B-0806", "tenant": "待出租", "category": "家电", "priority": "urgent", "status": "in_progress", "assignee": "维修组-刘工", "created_at": "2026-07-14", "due_at": "2026-07-15"},
    {"id": "M-240713-08", "title": "卫生间地漏反味", "room": "C-2103", "tenant": "周沐", "category": "管道", "priority": "high", "status": "open", "assignee": "客服-苏晴", "created_at": "2026-07-13", "due_at": "2026-07-16"},
    {"id": "M-240712-03", "title": "门锁电池电量低", "room": "A-1201", "tenant": "林思远", "category": "智能门锁", "priority": "medium", "status": "open", "assignee": "未分配", "created_at": "2026-07-12", "due_at": "2026-07-16"},
    {"id": "M-240711-11", "title": "墙面补漆", "room": "A-1608", "tenant": "赵安琪", "category": "装修", "priority": "low", "status": "resolved", "assignee": "维修组-刘工", "created_at": "2026-07-11", "due_at": "2026-07-12"},
]

TRANSACTIONS = [
    {"id": "F-20260714-001", "date": "2026-07-14", "type": "租金收入", "room": "A-1201", "tenant": "林思远", "amount": 6800, "method": "银行转账", "status": "paid", "note": "7 月租金"},
    ...
    {"id": "F-20260710-009", "date": "2026-07-10", "type": "租金收入", "room": "C-1905", "tenant": "陈予白", "amount": 12800, "method": "银行转账", "status": "paid", "note": "7 月租金"},
]

RECONCILIATION = [
    {"id": "R-001", "date": "2026-07-14", "bank_flow_id": "BK202607140091", "system_flow_id": "F-20260714-001", "payer": "林思远", "amount": 6800, "channel": "银行转账", "status": "matched", "difference": 0},
    {"id": "R-002", "date": "2026-07-14", "bank_flow_id": "AL202607140332", "system_flow_id": "F-MISSING-002", "payer": "赵安琪", "amount": 19200, "channel": "支付宝", "status": "pending", "difference": 0},
    {"id": "R-003", "date": "2026-07-13", "bank_flow_id": "WX202607130882", "system_flow_id": "F-20260713-006", "payer": "物业维修供应商", "amount": -860, "channel": "企业微信", "status": "exception", "difference": 0},
